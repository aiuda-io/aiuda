...
DUENO: frozenset[tuple[str, str]] = frozenset({
    ...
    ("GET", "/v1/agents/{slug}/config"),
    ("GET", "/v1/agents/{slug}/systems"),
    ("GET", "/v1/audit"),
    ...
    ("POST", "/v1/agents/{slug}/activate"),
    ("POST", "/v1/agents/{slug}/chat"),
    ("POST", "/v1/agents/{slug}/deactivate"),
    ...
    ("POST", "/v1/provider/openai/connect"),
    ("POST", "/v1/provider/openai/device/poll"),
    ("POST", "/v1/provider/openai/device/start"),
